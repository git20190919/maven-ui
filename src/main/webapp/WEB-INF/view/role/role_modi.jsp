...
<html>
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/role/updateRoleAction.do" method="post" class="main_form" enctype="multipart/form-data">
                ...
                <div class="input_info">
                    <img style="width:60px;height:60px;" src="${pageContext.request.contextPath}${role.by001}"/>
                    <span class="required">*</span>
                    <div class="validate_msg_medium">不能为空，且为20长度的字母、数字和汉字的组合</div>
                </div>        
                <div class="text_info clearfix"><span>修改角色图标：</span></div>
                <div class="input_info">
